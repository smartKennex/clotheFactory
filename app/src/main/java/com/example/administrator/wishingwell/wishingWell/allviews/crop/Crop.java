...
public class Crop {
    ...
    interface Extra {
        ...
        String MAX_Y = "max_y";
        String ERROR = "error";
        String CONFIRM = "confirm"; // 仅进行图像确认，不提示裁剪
    }
     ...
     *
     * @param source Source image URI, 传Null时，会使用CameraActivity.getmLatestBitmap()获得刚刚拍摄的照片
     */
     ...
     * 仅进行图像的二次确认，无裁剪框
     */
    public Crop asConfirm() {
        cropIntent.putExtra(Extra.CONFIRM, true);
        return this;
    }
    ...
    public static void pickImage(Activity activity) {
        ...
        try {
            ...
            Toast.makeText(WishingWellApp.getInstance().getApplicationContext(),
                    R.string.crop__pick_error, Toast.LENGTH_SHORT);
        }
    }
}
